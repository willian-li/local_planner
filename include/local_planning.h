...
private:
    ...
    mavros_msgs::State _DroneState;

    geometry_msgs::PoseStamped _PoseVel;
    geometry_msgs::TwistStamped _VelState;
    ...
    // 规划初始状态及终端状态
    Eigen::Vector3d start_pos, start_vel, start_acc, goal_pos, goal_vel,rest_pos;
    ...
    void drone_state_cb(const mavros_msgs::StateConstPtr &msg);
    void local_pos_cb(const geometry_msgs::PoseStampedConstPtr &msg);
    void local_vel_cb(const geometry_msgs::TwistStampedConstPtr &msg);
